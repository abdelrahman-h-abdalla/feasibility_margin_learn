...
from jet_leg.jet_leg.plotting.plotting_tools import Plotter
import random
from jet_leg.jet_leg.computational_geometry.math_tools import Math
from jet_leg.jet_leg.computational_geometry.computational_geometry import ComputationalGeometry
from jet_leg.jet_leg.dynamics.computational_dynamics import ComputationalDynamics
from jet_leg.jet_leg.dynamics.instantaneous_capture_point import InstantaneousCapturePoint
from jet_leg.jet_leg.computational_geometry.iterative_projection_parameters import IterativeProjectionParameters
from jet_leg.jet_leg.optimization.lp_vertex_redundancy import LpVertexRedundnacy

import matplotlib.pyplot as plt
from jet_leg.jet_leg.plotting.arrow3D import Arrow3D
...
extForce = np.array([100., 0.0, 0.0 * 9.81])  # units are N
...
#plotter.plot_polygon(np.transpose(IP_points), '--b', 'Support Region')
plt.show()