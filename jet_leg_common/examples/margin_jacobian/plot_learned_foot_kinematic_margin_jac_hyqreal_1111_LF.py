...
def plot_learnt_margin():
    ...
    network = MultiLayerPerceptron(in_dim=40, out_dim=1, hidden_layers=[512,256,128], activation=torch.nn.ReLU, dropout=0.0)
    ...
    for delta in delta_pos_range_vec_x:
        network_input = np.concatenate([
            ...
            np.zeros(12),
            np.array([0.34 + delta, 0.228759, -0.55]),
            np.array([0.34, -0.34, -0.55]),
            np.array([-0.54, 0.34, -0.55]),
            np.array([-0.54, -0.34, -0.55]),
            np.array([0.6]),
    ...
    for delta in delta_pos_range_vec_y:
        network_input = np.concatenate([
            np.array([0.0, 0.0, 1.0]),
            np.zeros(12),
            np.array([0.342784 , 0.34 + delta, -0.55]),
            np.array([0.34 , -0.34, -0.55]),
            np.array([-0.54, 0.34, -0.55]),
            np.array([-0.54, -0.34, -0.55]),
            np.array([0.6]),
...
def plot_analytical_margin():
    ...
    LF_foot = np.array([0.34, 0.34, -0.55])
    RF_foot = np.array([0.34, -0.34, -0.55])
    LH_foot = np.array([-0.54, 0.34, -0.55])
    RH_foot = np.array([-0.54, -0.34, -0.55])
