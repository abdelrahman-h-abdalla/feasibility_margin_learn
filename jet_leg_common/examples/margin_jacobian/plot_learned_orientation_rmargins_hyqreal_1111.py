...
def plot_analytical_margin():
    ...
    foot_id = 0
    margin_euler_x, margins_split_euler_x, jac_euler_x, jacs_split_euler_x = \
                            jac.plotMarginAndJacobianWrtBaseOrientation(params_euler_x, delta_orient_range_vec_x, 0)
    margin_euler_y, margins_split_euler_y, jac_euler_y, jacs_split_euler_y = \
                            jac.plotMarginAndJacobianWrtBaseOrientation(params_euler_y, delta_orient_range_vec_y, 1)
    margin_euler_z, margins_split_euler_z, jac_euler_z, jacs_split_euler_z = \
                            jac.plotMarginAndJacobianWrtBaseOrientation(params_euler_z, delta_orient_range_vec_z, 2)


    print("pos_margin_x:", margin_euler_x)
    print("pos_margin_y:", margin_euler_y)
    print("pos_margin_z:", margin_euler_z)
    print("pos_margin_x_split:", margins_split_euler_x)
    print("pos_margin_y_split:", margins_split_euler_y)
    print("pos_margin_z_split:", margins_split_euler_z)
    print("jac_com_pos_x:", jac_euler_x)
    print("jac_com_pos_y:", jac_euler_y)
    print("jac_com_pos_z:", jac_euler_z)
    print("jac_com_pos_x_split:", jacs_split_euler_x)
    print("jac_com_pos_y_split:", jacs_split_euler_y)
    print("jac_com_pos_z_split:", jacs_split_euler_z)
        
    return [[margin_euler_x, margin_euler_y, margin_euler_z],
            [margins_split_euler_x, margins_split_euler_y, margins_split_euler_z],
            [jac_euler_x, jac_euler_y, jac_euler_z],
            [jacs_split_euler_x, jacs_split_euler_y, jacs_split_euler_z]]
...
def main():
    ...
    plt.subplot(131)
    plt.plot(delta_orient_range_vec_x, margin[0], 'g', markersize=15, label='min_margin')
    plt.plot(delta_orient_range_vec_x, margins_split[0][0], 'b', markersize=15, label='margin_x')
    plt.plot(delta_orient_range_vec_x, margins_split[0][1], 'r', markersize=15, label='margin_y')
    plt.grid()
    plt.xlabel("$\theta_x$ [m]")
    plt.ylabel("m [m]")
    ...
    plt.subplot(132)
    plt.plot(delta_orient_range_vec_y, margin[1], 'g', markersize=15, label='min_margin')
    plt.plot(delta_orient_range_vec_y, margins_split[1][0], 'b', markersize=15, label='margin_x')
    plt.plot(delta_orient_range_vec_y, margins_split[1][1], 'r', markersize=15, label='margin_y')
    plt.grid()
    plt.xlabel("$\theta_x$ [m]")
    plt.ylabel("m [m]")
    ...
    plt.subplot(133)
    plt.plot(delta_orient_range_vec_z, margin[2], 'g', markersize=15, label='min_margin')
    plt.plot(delta_orient_range_vec_z, margins_split[2][0], 'b', markersize=15, label='margin_x')
    plt.plot(delta_orient_range_vec_z, margins_split[2][1], 'r', markersize=15, label='margin_y')
    plt.grid()
    plt.xlabel("$\theta_z$ [m]")
    plt.ylabel("m [m]")
    ...
    plt.subplot(131)
    plt.plot(delta_orient_range_vec_x, jacobian[0][0], 'g', markersize=15, label='min_margin')
    plt.plot(delta_orient_range_vec_x, jacobians_split[0][0][0], 'b', markersize=15, label='margin_x')
    plt.plot(delta_orient_range_vec_x, jacobians_split[0][1][0], 'r', markersize=15, label='margin_y')
    plt.grid()
    ...
    plt.subplot(132)
    plt.plot(delta_orient_range_vec_y, jacobian[1][1], 'g', markersize=15, label='min_margin')
    plt.plot(delta_orient_range_vec_y, jacobians_split[1][0][1], 'b', markersize=15, label='margin_x')
    plt.plot(delta_orient_range_vec_y, jacobians_split[1][1][1], 'r', markersize=15, label='margin_y')
    plt.grid()
    ...
    plt.subplot(133)
    plt.plot(delta_orient_range_vec_z, jacobian[2][2], 'g', markersize=15, label='min_margin')
    plt.plot(delta_orient_range_vec_z, jacobians_split[2][0][2], 'b', markersize=15, label='margin_x')
    plt.plot(delta_orient_range_vec_z, jacobians_split[2][0][2], 'r', markersize=15, label='margin_y')
    plt.grid()
