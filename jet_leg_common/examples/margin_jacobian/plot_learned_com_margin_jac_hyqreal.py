...
def plot_learnt_margin():
    ...
    network = MultiLayerPerceptron(in_dim=40, out_dim=1, hidden_layers=[256,128,128], activation=F.softsign, dropout=0.0)
...
def plot_analytical_margin():
    ...
    print("pos_margin_z:", pos_margin_z)
    print("jac_com_pos_x:", jac_com_pos_x)
    print("jac_com_pos_y:", jac_com_pos_y)
    print("jac_com_pos_z:", jac_com_pos_z)
