...
def plot_learnt_margin():
    ...
    dataset_handler = TrainingDataset('stability_margin/1101', robot_name=robot_name, in_dim=34)
    ...
    network = MultiLayerPerceptron(in_dim=34, out_dim=1, hidden_layers=[512,256,128], activation='softsign', dropout=0.0)
    ...
    for delta in delta_pos_range_vec_y:
        ...
        jac_array_x.append(-1 * (unnormalized_gradient[16] + unnormalized_gradient[19] + unnormalized_gradient[22]))
